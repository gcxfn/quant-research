#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""wave-25 标注辅助：生成"ordinal|REASON"单行紧凑视图（控制标注上下文预算）。

沿自 wave-24 extract_cues.py，仅改 batch 默认 24→25，产物 work/batch_025_cues.txt；
...
用法: python extract_cues.py --repo-root D:/量化 [--batch 25]
产物: work/batch_025_cues.txt
"""
import argparse
import csv
import glob

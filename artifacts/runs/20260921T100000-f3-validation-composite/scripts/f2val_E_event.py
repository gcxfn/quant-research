...
OUT = str(_OUT_ROOT / f"factor_{_WINDOW}" / "E_event")
...
F = read_chunks(os.path.join(TS, "forecast", "20260909-r1", "chunk_*.csv"),
                "201809",
                "202412" if _WINDOW == "val" else "202012")
...
DEV_HI = date(2024, 12, 31) if _WINDOW == "val" else date(2020, 12, 31)

...
F2R1 = ROOT / "artifacts/runs/20260919T180000-f2r1-factor-batch/outputs"
...
ARMS = ["F3-EW", "F3-ICW"]
K = 10
ENGINE_SHA_EXPECT_FULL = ("84a2443ac28fe1b87e4a18f988fd38cc67cf706d"
                          "5778e262f11465147234082c")
...
assert surv.height == 42, f"expected 42 survivors, got {surv.height}"

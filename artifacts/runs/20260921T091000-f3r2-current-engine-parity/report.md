...
- 运行 `20260921T091000-f3r2-current-engine-parity`；引擎 v1.3 sha256:16 `31022babbc2858ea`（运行前后一致；corporate_actions=None = v1.2 行为路径）；预登记 sha256:16 `bd56fb5cfb5da4df`（已冻结，运行中零修改）；继承条款 v3 预登记 sha256:16 `8e3c534fad39e3e7`、F3R1 预登记 sha256:16 `858beb421421ccb4`。
...
| F3R2-EW | +7.74% | +0.60% | +7.14pp | 4/6 | -24.88% | 4.01 | 25.0% | 0+0/2=0.0% | 0/2=0.0% | 58.7% | N | 5 | 3_advantage_years_ge_5_of_6, 4_mdd_le_20pct_and_le_B1m, 8v3_final_delivery_ge_99pct | eliminated |
| F3R2-ICW | +8.54% | +0.60% | +7.94pp | 5/6 | -27.69% | 2.59 | 32.4% | 0+0/1=0.0% | 0/1=0.0% | 46.6% | N | 6 | 4_mdd_le_20pct_and_le_B1m, 8v3_final_delivery_ge_99pct | eliminated |

### 一句话死因

- **F3R2-EW**: advantage years<5/6 (gate 3); maxDD breach (gate 4); final delivery<99% (gate 8v3)（腿 sh.511010 15%; sh.518880 25%，park 40%）
- **F3R2-ICW**: maxDD breach (gate 4); final delivery<99% (gate 8v3)（腿 sh.511010 15%; sh.518880 25%，park 40%）
...
- **F3R2-EW**: 门8v3 最终交付 0+0/2=0.0%；限价直接成交率 6.6%；滑点(vs源信号收盘) 买 +0.474% 卖 +0.024%；分年 {"2015": 0.107, "2016": 0.2014, "2017": 0.1068, "2018": -0.1443, "2019": 0.1204, "2020": 0.1069}；终止 {"expiry": 7, "override_same_name": 205, "cap_void": 0, "suspension_abandon": 5}；DD窗(2015-06-16→2015-09-15) 归因: 股票腿 55.8% / ETF腿 2.1% / 现金 42.1%；sh.511010: 实际均重 8.6%/max 11.8% (目标 15%); sh.518880: 实际均重 20.7%/max 25.0% (目标 25%)；vs F3R2-A0: 腿成交 +203 单, 现金不足作废 1716 次（锚 33 次）
- **F3R2-ICW**: 门8v3 最终交付 0+0/1=0.0%；限价直接成交率 1.5%；滑点(vs源信号收盘) 买 +0.279% 卖 -0.251%；分年 {"2015": 0.1427, "2016": 0.2104, "2017": 0.0024, "2018": -0.1351, "2019": 0.136, "2020": 0.1988}；终止 {"expiry": 10, "override_same_name": 271, "cap_void": 0, "suspension_abandon": 6}；DD窗(2015-06-16→2015-09-15) 归因: 股票腿 32.8% / ETF腿 1.8% / 现金 65.4%；sh.511010: 实际均重 8.5%/max 11.8% (目标 15%); sh.518880: 实际均重 20.3%/max 26.5% (目标 25%)；vs F3R2-A0: 腿成交 +76 单, 现金不足作废 4202 次（锚 33 次）

### F3 股票腿预算与参考（F3R2 预登记 §3）

| 臂 | 入场次数 | 退出次数 | 风险位月数 | 均w_T | 净CAGR | maxDD | 失败门 |
|---|---|---|---|---|---|---|---|
| F3R2-EW (EW) | 174 | 171 | 32 | 0.1499 | +7.74% | -24.88% | 3_advantage_years_ge_5_of_6, 4_mdd_le_20pct_and_le_B1m, 8v3_final_delivery_ge_99pct |
| F3R2-ICW (ICW) | 185 | 182 | 32 | 0.1499 | +8.54% | -27.69% | 4_mdd_le_20pct_and_le_B1m, 8v3_final_delivery_ge_99pct |

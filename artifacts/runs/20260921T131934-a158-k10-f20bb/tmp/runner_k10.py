...
GCFGS = ["G0", "G1", "G2", "G3"]
CURVES = ["MLK10G0", "MLK10G3"]
GCFG_OF = {"MLK10G0": "G0", "MLK10G3": "G3"}
LEG, GCFG = "MF", "G3"
...
def _fail(reason: str) -> None:
    ...
    (RUN_DIR / "manifest.json").write_text(json.dumps({
        "run_id": RUN_DIR.name,
        "experiment_id": "exp-20260921-alpha158-k10",

...
CONFIG_IDS = ["C05"]  # v1.3 anchor replay: C05 only
ENGINE_SHA_EXPECT_FULL = ("84a2443ac28fe1b87e4a18f988fd38cc67cf706d5778e"
                          "262f11465147234082c")  # v1.3 engine
EXPECT = {
...
BUDGET_S = 3600.0
PEAK_RSS = 0.0
LOG_PATH = RUN_DIR / "logs" / "anchor1_p3r2_c05.log"
LOG_LINES: list[str] = []
...
LEGS: dict = {}
PANEL_BY_CFG: dict = {}  # v1.3 replay: keyed for ALL leg_log configs
for _c in CONFIG_IDS:
    PANEL_BY_CFG[_c] = set()
OUTCOME: dict = {}

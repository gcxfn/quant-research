#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""wave-13 标注辅助：生成"ordinal|type|REASON"单行紧凑视图（控制标注上下文预算）。

沿自 wave-12 extract_cues.py，仅改 batch 默认 12→13，产物 work/batch_013_cues.txt；
行前缀延续 wave-12 的"ordinal|type|REASON"格式（批 13 区段 type 同样混合）。
...
用法: python extract_cues.py --repo-root D:/量化 [--batch 13]
产物: work/batch_013_cues.txt
"""
import argparse
import csv
import glob

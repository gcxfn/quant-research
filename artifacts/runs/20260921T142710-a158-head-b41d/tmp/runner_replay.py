# -*- coding: utf-8 -*-
"""HEAD-optimised Alpha158 ML replay (prereg exp-20260921-a158-head-ml).

Base script: fixed-scheme R2 replay (frozen MF leg structure);
the ONLY change is the ml_scores.json source (probabilities from the
head-labelled classifier). Prereg: docs/research/exp-20260921-a158-head-ml-prereg.md
...
PREREG = ROOT / "docs/research/exp-20260921-a158-head-ml-prereg.md"
...
def _fail(reason: str) -> None:
    ...
    (RUN_DIR / "manifest.json").write_text(json.dumps({
        "run_id": RUN_DIR.name,
        "experiment_id": "exp-20260921-a158-head-ml",
...
import json as _j
ML_PRED = _j.loads((ROOT / "artifacts/runs/20260921T142710-a158-head-b41d"
...
manifest = {
    ...
    "pins": pins,
    "curves": CURVES,
    "trial_accounting": {"strategy_line": {"before": 288, "this_round":
                                           0 if SMOKE else 1, "after":
                                           288 if SMOKE else 289},

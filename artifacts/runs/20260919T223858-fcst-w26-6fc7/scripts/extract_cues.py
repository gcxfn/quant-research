#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""wave-26 标注辅助：生成"ordinal|REASON"单行紧凑视图（控制标注上下文预算）。

沿自 wave-25 extract_cues.py，仅改 batch 默认 25→26，产物 work/batch_026_cues.txt；
行前缀查 row_index 后本批 ordinals 15000–15599 共 600 行 type 分布为
...
用法: python extract_cues.py --repo-root D:/量化 [--batch 26]
产物: work/batch_026_cues.txt
"""
import argparse
import csv
import glob

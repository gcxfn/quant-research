...
- 运行 `20260919T201500-f3r3-industry-cap-4b2e`；引擎 v1.3 sha256:16 `84a2443ac28fe1b8`（运行前后一致；corporate_actions=None = v1.2 行为路径）；预登记 sha256:16 `1046602402ac6220`（已冻结，运行中零修改）；继承条款 v3 预登记 sha256:16 `8e3c534fad39e3e7`、F3R1 预登记 sha256:16 `858beb421421ccb4`。
...
| F3R3-EW | +4.88% | +0.60% | +4.28pp | 4/6 | -17.85% | 4.45 | 28.0% | 5+0/6=83.3% | 5/6=83.3% | 79.4% | N | 6 | 3_advantage_years_ge_5_of_6, 8v3_final_delivery_ge_99pct | eliminated |
| F3R3-ICW | +3.42% | +0.60% | +2.82pp | 3/6 | -19.27% | 5.17 | 28.0% | 4+1/6=83.3% | 4/6=66.7% | 82.1% | N | 6 | 3_advantage_years_ge_5_of_6, 8v3_final_delivery_ge_99pct | eliminated |

### 一句话死因

- **F3R3-EW**: advantage years<5/6 (gate 3); final delivery<99% (gate 8v3)（腿 sh.511010 15%; sh.518880 25%，park 40%）
- **F3R3-ICW**: advantage years<5/6 (gate 3); final delivery<99% (gate 8v3)（腿 sh.511010 15%; sh.518880 25%，park 40%）
...
- **F3R3-EW**: 门8v3 最终交付 5+0/6=83.3%；限价直接成交率 30.1%；滑点(vs源信号收盘) 买 +0.343% 卖 +0.271%；分年 {"2015": 0.1437, "2016": 0.0093, "2017": 0.0219, "2018": -0.1111, "2019": 0.2038, "2020": 0.0536}；终止 {"expiry": 8, "override_same_name": 247, "cap_void": 0, "suspension_abandon": 15}；DD窗(2018-01-25→2018-10-18) 归因: 股票腿 201.2% / ETF腿 10.1% / 现金 -113.1%；sh.511010: 实际均重 12.7%/max 15.1% (目标 15%); sh.518880: 实际均重 22.4%/max 28.0% (目标 25%)；vs F3R3-A0: 腿成交 +944 单, 现金不足作废 1033 次（锚 33 次）
- **F3R3-ICW**: 门8v3 最终交付 4+1/6=83.3%；限价自成交 sh.603996 2019-06-11；限价直接成交率 25.0%；滑点(vs源信号收盘) 买 +0.455% 卖 +0.382%；分年 {"2015": 0.17, "2016": 0.0191, "2017": -0.0345, "2018": -0.0834, "2019": 0.0858, "2020": 0.0673}；终止 {"expiry": 6, "override_same_name": 229, "cap_void": 0, "suspension_abandon": 13}；DD窗(2016-08-18→2018-10-18) 归因: 股票腿 69.6% / ETF腿 15.3% / 现金 17.2%；sh.511010: 实际均重 12.9%/max 15.1% (目标 15%); sh.518880: 实际均重 22.5%/max 28.0% (目标 25%)；vs F3R3-A0: 腿成交 +1028 单, 现金不足作废 1443 次（锚 33 次）

### F3 股票腿预算与行业约束（F3R3 预登记 §3）

| 臂 | 入场次数 | 退出次数 | 风险位月数 | 均w_T | 净CAGR | maxDD | 失败门 |
|---|---|---|---|---|---|---|---|
| F3R3-EW (EW) | 510 | 500 | 32 | 0.0450 | +4.88% | -17.85% | 3_advantage_years_ge_5_of_6, 8v3_final_delivery_ge_99pct |
| F3R3-ICW (ICW) | 570 | 562 | 32 | 0.0450 | +3.42% | -19.27% | 3_advantage_years_ge_5_of_6, 8v3_final_delivery_ge_99pct |
...
- 判定：no ARM passed all dev gates (0/2); F-line stops here per the F3R3 prereg stop clause (F3R4 is a separate user decision); val not consumed

# -*- coding: utf-8 -*-
"""Trim-leg caliber comparison (RISK group), prereg exp-20260921-trim-risk-fallback.

Derived verbatim from the task-1 account-risk runner; ONLY the engine pin
(v1.5 d4b6c3764780e6de) and trim_intent ("risk") differ.
...
def make_provider(arm: str, config_id: str, marks: LedgerMarks):
    ...
    host = DynamicOverlayHost(config_id, marks, trim_intent='risk')

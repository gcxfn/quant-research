...
- 运行 `20260919T222634-engine-v14-impl`；引擎 v1.2 sha256:16 `7ad35014d72711cb`（运行前后一致，v2 prereg §5 pin 零改动）；预登记 sha256:16 `4ced8ce1db44cef3`（已冻结，运行中零修改）；继承条款 v1 预登记 sha256:16 `266a1b850373a6f7`。

...
Prereg (frozen): docs/research/exp-20260921-etf-momentum-comb-prereg.md
...
def _fail(reason: str) -> None:
    ...
    (RUN_DIR / "manifest.json").write_text(json.dumps({
        "run_id": RUN_DIR.name,
        "experiment_id": "exp-20260921-etf-momentum-comb",
...
manifest = {
    ...
    "trial_accounting": {"strategy_line": {
        "before": 289, "this_round": 0 if SMOKE else 1,
        "after": 289 if SMOKE else 290}},

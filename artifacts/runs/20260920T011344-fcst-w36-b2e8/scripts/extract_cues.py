#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""wave-34 标注辅助：生成"ordinal|REASON"单行紧凑视图（控制标注上下文预算）。

沿自 wave-35 extract_cues.py，仅改 batch 默认 35→36，产物 work/batch_036_cues.txt；
行前缀查 row_index 后本批 ordinals 21000–21599 共 600 行 type 分布为
...
用法: python extract_cues.py --repo-root D:/量化 [--batch 34]
产物: work/batch_036_cues.txt
"""
import argparse
import csv
import glob

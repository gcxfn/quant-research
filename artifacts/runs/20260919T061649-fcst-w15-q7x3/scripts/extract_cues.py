#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""wave-15 标注辅助：生成"ordinal|REASON"单行紧凑视图（控制标注上下文预算）。

沿自 wave-13 extract_cues.py，仅改 batch 默认 14→15，产物 work/batch_015_cues.txt；
行前缀查 row_index 后简化为"ordinal|REASON"（批 15 区段 type 分布 600 行全部为
...
用法: python extract_cues.py --repo-root D:/量化 [--batch 15]
产物: work/batch_015_cues.txt
"""
import argparse
import csv
import glob
